...
CHARACTER_PRESETS = {
    ...
    "streamer": {
        "character": "streamer",
        "display_name": "Douyin Live-Commerce Streamer",
        "identity_label": "Live-commerce streamer",
        "gallery_category": "Streamer",
        "source_domain": "commerce",
        "relationship_to_user": "public_commerce_creator",
        "is_real_person": True,
        "is_public_figure": True,
        "is_fictional": False,
        "command_aliases": ["/create-streamer", "/create-skill"],
        "knowledge_dirs": COMMON_KNOWLEDGE_DIRS + [
            "research/raw",
            "research/merged",
            "research/reviews",
        ...
        "storage_root": "skills/streamer",
        "prompt_bundle": {
            "preset": "dot.streamer.v1",
            "intake": "prompts/streamer/intake.md",
            "work_analyzer": "prompts/streamer/work_analyzer.md",
            "persona_analyzer": "prompts/streamer/persona_analyzer.md",
            "work_builder": "prompts/streamer/work_builder.md",
            "persona_builder": "prompts/streamer/persona_builder.md",
            "script_generator": "prompts/streamer/script_generator.md",
            "compliance": "prompts/streamer/compliance.md",
            "merger": "prompts/streamer/merger.md",
            "correction_handler": "prompts/correction_handler.md",
        },
        "streamer_tools": {
            "douyin_profile_parser": "tools/douyin_profile_parser.py",
            "asr_segmenter": "tools/asr_segmenter.py",
            "streamer_deep_metrics": "tools/streamer_deep_metrics.py",
            "streamer_compliance_check": "tools/streamer_compliance_check.py",
            "streamer_script_quality_check": "tools/streamer_script_quality_check.py",
            "streamer_quality_check": "tools/streamer_quality_check.py",
        },
        "references": [
        ...
        "legacy_storage_root": "skills/streamer",
        "skill_name_prefix": "streamer",
        "legacy_type": "streamer",
    },
}
...
CHARACTER_ALIASES = {
    ...
    "nuwa": "celebrity",
    "douyin-streamer": "streamer",
    "live-commerce": "streamer",
